...
use Lumia\Http\Controllers\Auth\Traits\ThrottlesLogins;
...
class LoginController extends Controller
{
    ...
    {
        return $this->respondWithError('Your credentials are invalid');
    }
    ...
    {
        return [
            $this->username() => 'Please enter a valid emails address',
